...
import (
	...
	"github.com/carmel/qrcp/qr"

	"github.com/carmel/qrcp/body"
	"github.com/carmel/qrcp/config"
	"github.com/carmel/qrcp/pages"
	"github.com/carmel/qrcp/util"
...
func New(cfg *config.Config) (*Server, error) {
	...
	app.SendURL = fmt.Sprintf("%s/s", app.BaseURL)
	app.ReceiveURL = fmt.Sprintf("%s/r", app.BaseURL)
	// Create a server
